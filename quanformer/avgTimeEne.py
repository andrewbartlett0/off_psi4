...
if __name__ == "__main__":
    ...
    parser.add_argument("--relene", action="store_true", default=False,
        help="If specified, get lists of relative energies of all conformers\
              relative to first conformer in common that successfully\
              completed its QM calculation.")
    ...
    if (opt['time'] or opt['relene']):
        ...
        except NameError: raise parser.error("Method and basis set must be supplied for\
 time or relative energy analysis.")
